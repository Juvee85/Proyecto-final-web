 ...
 * @author juventino
 */
public class FiltroAuntenticacion implements Filter {

    private static final boolean debug = true;
    private String[] urlPublicas = {"login.html", "registro.html", "styles.css", "registro.js"};
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("FiltroAuntenticacion:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FiltroAuntenticacion()");
        }
        StringBuffer sb = new StringBuffer("FiltroAuntenticacion(");
